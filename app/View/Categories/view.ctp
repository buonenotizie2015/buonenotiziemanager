...
?>
	<div class="related">
		...
		<table id="rssitems" class="tablesorter" cellpadding = "0" cellspacing = "0">
			<thead>
				<tr>
			...
			?>
				<tr <?php echo $inserted!=false ? 'style="background-color:#d6f1dd"' : ''; ?> >
		...
		<dl>
		<?php foreach($channel['channel'] as $feedFieldName => $feedFieldVal) : ?>
		...
		<h4>Feed XML</h4>
		<pre><?php print_r($channel['channel']); ?></pre>
